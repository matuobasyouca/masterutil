package com.zscp.master.util.image;
...
public final class ImageUtil {
     ...
     * @throws IOException IO异常
     */
    public static void mergeBothImage(String negativeImagePath, String additionImagePath, String imageFormat, int x, int y, String toPath) throws IOException {
        InputStream is = null;
